...
void loop() {
  ...
  if (temp == K1)
  {
    ...
    if (new_mode_level == MODE1_L1)
    {
      new_mode_level = MODE1_L2;
  ...
  else if (temp == K2)
  {
    Serial.print("key = ");
    Serial.println(temp, HEX);
    if (new_mode_level == MODE2_L1)
    {
      new_mode_level = MODE2_L2;
      digitalWrite(MODE1_L1_LED, HIGH);
      digitalWrite(MODE1_L2_LED, HIGH);
